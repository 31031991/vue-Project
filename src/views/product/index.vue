...
<div>
  <main class="overflow-hidden ">
    ...
    <div class="breadcrumb-area" style="background-image: url(/images/inner-pages/breadcum-bg.png);">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            ...
            <div class="product-categories-one__inner">
              <ul>
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img1.png"
                                           alt="" /> </div>
                </a>
                ...
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img2.png"
                                           alt="" /> </div>
                </a>
                  <div class="title"> <a href="#0">
                    <h6>Furnitures</h6>
                ...
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img3.png"
                                           alt="" /> </div>
                </a>
                  <div class="title"> <a href="#0">
                    <h6>Jewellery</h6>
                ...
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img4.png"
                                           alt="" /> </div>
                </a>
                  <div class="title"> <a href="#0">
                    <h6>Shoes</h6>
                ...
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img5.png"
                                           alt="" /> </div>
                </a>
                  <div class="title"> <a href="#0">
                    <h6>Electronics</h6>
                ...
                <li> <a href="#0" class="img-box">
                  <div class="inner"> <img src="/images/shop/product-categories-v1-img6.png"
                                           alt="" /> </div>
                </a>
                  <div class="title"> <a href="#0">
                    <h6>Fashion</h6>
                    ...
                    <div class="row">
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single w-100  mt-30">
                          <div class="products-three-single-img"> <a
                              ...
                              src="/images/home-three/productss2-1.jpg"
                              class="first-img" alt="" /> <img
                              src="/images/home-three/productss2-hover-1.png"
                              alt="" class="hover-img" />
                          </a>
                        ...
                        <div class="products-three-single  w-100  ">
                          <div class="products-three-single-img">
                            <a href="shop-details-3.html" class="d-block">
                              <img src="/images/home-three/productss2-hover-2.png"
                                   class="first-img" alt="" />
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tabb33">
                                              <img src="/images/shop/products-v6-img8.jpg"
                                                   alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single  w-100 ">
                          <div class="products-three-single-img">
                            <a href="shop-details-3.html" class="d-block">
                              <img src="/images/home-three/productss2-3.jpg"
                                   alt="" />
                            </a>
                                      ...
                                      <div class="tabs">
                                        ...
                                        <div
                                          ...
                                          <div id="tabb333"
                                            ...
                                            <div
                                                class="popup-product-single-image">
                                              <img src="/images/shop/products-v6-img9.jpg"
                                                   alt="" /> </div>
                                          </div> <button class="prev"> <i
                                            class="flaticon-back"></i>
                                        </button> <button class="next"> <i
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="payment-method"> <a href="#0">
                                        <img src="/images/payment_method/method_1.png"
                                             alt="">
                                      </a> <a href="#0"> <img
                                          src="/images/payment_method/method_2.png"
                                          alt="">
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single  w-100 ">
                          <div class="products-three-single-img"> <a
                              href="shop-details-3.html" class="d-block"> <img
                              src="/images/home-three/productss2-4.jpg"
                              alt="" />
                          </a>
                            <div class="products-grid-one__badge-box"> <span
                                    ...
                                    <div class="tabs">
                                      ...
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tabb3333"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/products-v6-img10.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single  w-100  ">
                          <div class="products-three-single-img">
                            <a href="shop-details-3.html" class="d-block">
                              <img src="/images/home-three/productss2-5.jpg"
                                   class="first-img" alt="" />
                              <img src="/images/home-three/productss2-hover-5.png"
                                   alt="" class="hover-img" />
                            </a>
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single   w-100 ">
                          <div class="products-three-single-img">
                            <a href="shop-details-3.html" class="d-block">
                              <img src="/images/home-three/productss3-1.jpg"
                                   class="first-img" alt="" />
                              <img src="/images/home-three/productss3-hover-1.jpg"
                                   alt="" class="hover-img" />
                            </a>
                            <div class="products-grid-one__badge-box"> <span
                                class="bg_base badge new ">New</span>
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          <li
                                              class="tab-nav popup-product-thumb">
                                            <a href="#tab1">
                                              <img src="/images/shop/products-v6-img1.jpg"
                                                   alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab2">
                                              <img src="/images/shop/products-v6-img2.jpg"
                                                   alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab3">
                                              <img src="/images/shop/products-v6-img3.jpg"
                                                   alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single wow w-100 fadeInUp animated">
                          <div class="products-three-single-img"> <a
                              href="shop-details-3.html" class="d-block"> <img
                              src="/images/home-three/productss3-2.jpg"
                              alt="" />
                        ...
                        <div class="products-three-single  wow w-100 ">
                          <div class="products-three-single-img">
                            <a href="shop-details-3.html" class="d-block"> <img
                                src="/images/home-three/productss3-3.jpg"
                                class="first-img" alt="" />
                              <img src="/images/home-three/productss3-hover-3.png"
                                   alt="" class="hover-img" />
                            </a>
                            <div class="products-grid-one__badge-box"> <span
                                class="bg_base badge new ">New</span>
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab222">
                                              <img src="/images/shop/products-v6-img4.jpg"
                                                   alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab333">
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single  wow w-100 ">
                          <div class="products-three-single-img"> <a
                              href="shop-details-3.html" class="d-block"> <img
                              src="/images/home-three/productss3-4.jpg"
                              alt="" />
                          </a> <a href="cart.html" class="addcart btn--primary style2">
                            Add To Cart </a>
                            <div class="products-grid__usefull-links">
                      ...
                      <div class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single  wow w-100 ">
                          <div class="products-three-single-img img-bg">
                            <a href="shop-details-3.html" class="d-block">
                              <img src="/images/home-three/productss2-1.jpg"
                                   alt="" />
                              <div class="products-grid-one__badge-box"> <span
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="payment-method"> <a
                                          ...
                                          src="/images/payment_method/method_1.png"
                                          alt=""> </a> <a href="#0">
                                        <img src="/images/payment_method/method_2.png"
                                             alt=""> </a> <a href="#0">
                                        <img src="/images/payment_method/method_3.png"
                                             alt=""> </a> <a href="#0">
                                        <img src="/images/payment_method/method_4.png"
                                             alt=""> </a> </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="product-grid-two list mt-30 ">
                          <div class="product-grid-two__img">
                            <a href="shop-details-2.html" class="d-block"> <img
                                src="/images/home-three/products-1.jpg"
                                class="first-img" alt="" /> <img
                                src="/images/home-three/products-hover-1.png"
                                        ...
                                        <ul>
                                          <li
                                            ...
                                            <a href="#tab7111111b"> <img
                                                src="/images/shop/shop-grid-page-img1.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab8111111b"> <img
                                                src="/images/shop/shop-grid-page-img2.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab9111111b"> <img
                                                src="/images/shop/shop-grid-page-img3.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        <div id="tab7111111b"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img1.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tab8111111b"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img2.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tab9111111b"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img3.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab3z"> <img
                                                src="/images/shop/shop-grid-page-img4.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tab3z"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img4.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img">
                            <a href="shop-details-2.html" class="d-block"> <img
                                src="/images/home-three/products-3.jpg" alt="" />
                            </a>
                            <div class="products-grid-one__badge-box"> <span
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab6zz"> <img
                                                src="/images/shop/shop-grid-page-img5.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tab6zz"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img5.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          <li
                                              class="tab-nav popup-product-thumb">
                                            <a href="#tab44cc"> <img
                                                src="/images/home-two/products-v5-img4.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab55cc"> <img
                                                src="/images/home-two/products-v5-img5.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab66cc"> <img
                                                src="/images/home-two/products-v5-img6.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        <div id="tab44cc"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/home-two/products-v5-img4.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tab55cc"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/home-two/products-v5-img5.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tab66cc"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/home-two/products-v5-img6.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img"> <a href="shop-details-2.html"
                                                                 class="d-block"> <img
                              src="/images/home-three/products-5.png" alt="" />
                          </a>
                            <div class="products-grid-one__badge-box"> <span
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab555vv"> <img
                                                src="/images/shop/shop-grid-page-img6.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab666vv"> <img
                                                src="/images/shop/shop-grid-page-img7.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tab555vv"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img6.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tab666vv"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img7.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img"> <a href="shop-details-2.html"
                                                                 class="d-block"> <img
                              src="/images/home-three/products-6.png" alt="" />
                          </a> </div>
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab14bb"> <img
                                                src="/images/shop/shop-grid-page-img8.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tab14bb"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img8.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tab17nn"> <img
                                                src="/images/shop/shop-grid-page-img9.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tab17nn"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img9.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img"> <a href="shop-details-2.html"
                                                                 class="d-block"> <img
                              src="/images/home-three/productss2-2.jpg"
                              class="first-img" alt="" /> <img
                              src="/images/home-three/productss2-hover-2.png"
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          <li
                                              class="tab-nav popup-product-thumb">
                                            <a href="#tabk1mm"> <img
                                                src="/images/home-two/products-v5-img8.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tabk2mm"> <img
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tabk3mm"> <img
                                                src="/images/home-two/products-v5-img1.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        <div id="tabk1mm"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/home-two/products-v5-img8.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tabk2mm"
                                             class="tab-item popup-product-image">
                                        ...
                                        <div id="tabk3mm"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/home-two/products-v5-img1.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                                      ...
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          ...
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tabr2jj"> <img
                                                src="/images/shop/shop-grid-page-img10.jpg"
                                                alt="" /> </a> </li>
                                          <li
                                              class="tab-nav popup-product-thumb ">
                                            <a href="#tabr3jj"> <img
                                                src="/images/shop/shop-grid-page-img11.jpg"
                                                alt="" /> </a> </li>
                                        </ul>
                                      </div>
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <div id="tabr2jj"
                                          ...
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img10.jpg"
                                                 alt="" /> </div>
                                        </div>
                                        <div id="tabr3jj"
                                             class="tab-item popup-product-image">
                                          <div
                                              class="popup-product-single-image">
                                            <img src="/images/shop/shop-grid-page-img11.jpg"
                                                 alt="" /> </div>
                                        </div> <button class="prev"> <i
                                          class="flaticon-back"></i>
                                      </button> <button class="next"> <i
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img"> <a href="shop-details-2.html"
                                                                 class="d-block">
                            <img src="/images/home-three/productss2-4.jpg"
                                 alt="" /> </a> </div>
                          <div id="popupr11hh"
                               class="product-gird__quick-view-popup mfp-hide">
                            <div class="container">
                      ...
                      <div class="col-12">
                        <div class="product-grid-two list mt-30">
                          <div class="product-grid-two__img"> <a href="shop-details-2.html"
                                                                 class="d-block"> <img
                              src="/images/home-three/productss3-1.jpg"
                              alt="" /> </a> </div>
                          <div id="popupr111g"
                               class="product-gird__quick-view-popup mfp-hide">
                            <div class="container">
