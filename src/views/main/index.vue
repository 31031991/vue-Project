    ...
    <main class="overflow-hidden">
        ...
        <div class="row align-items-center justify-content-sm-between">
          <div class="col-lg-5 d-lg-block d-none">
            <div class="newsLetter-popup__thumb imgenews">
              <img src="../public/images/home-three/products-1.jpg" alt="newsletter">
            </div>
          </div>
          <div class="col-lg-7 col-md-8 col-sm-10">
            <div class="newsLetter-popup__content mb-4">
              <div class="text-center"> <a href="index.html" class="logo"> <img
                  src="../public/images/logo/logo.png" alt="logo"> </a>
        ...
        <div class="banner-slide3 slick" data-slick='{"dots": true, "infinite": true, "speed": 600, "slidesToShow": 1,
          ...
          <div class="slide">
            <div class="contant-box position-relative">
              ...
              <img class="bg-img hundread-vh" src="../public/images/home-three/home-3-bg.jpg" alt="image">
          ...
          <div class="slide">
            <div class="contant-box position-relative">
              ...
              <img class="bg-img hundread-vh" src="../public/images/home-three/home-3-bg-2.jpg" alt="image">
          ...
          <div class="row mt--30">
            <div class="col-lg-6 h-100 mt-30">
              <a href="shop-grid.html" class="catagory-single one home3cat">
                <img src="../public/images/home-three/cat-1.png" alt="#" class="background-img bg-img imgone">
                <div class="content">
              ...
              <div class="row">
                <div class="co-12 mt-30 ">
                  <a href="shop-grid.html" class="catagory-single home3cat">
                    <img src="../public/images/home-three/catbg-3.png" alt=""
                ...
                <div class="col-12 mt-30">
                  <a href="shop-grid.html" class="catagory-single home3cat">
                    <img src="../public/images/home-three/catbg-2.png" alt=""
                         class="background-img bg-img">
                    <div class="content">
                      <div class="row w-100 h-100 align-items-center">
                ...
                <div class="catagory-slider-three">
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-1.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/products-hover-1.png" alt=""
                               class="hover-img" />
                        </a>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-2.jpg" alt="" />
                        </a>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-3.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/products-hover-3.png" alt=""
                               class="hover-img" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-4.jpg" alt="" />
                        </a>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-5.png" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/products-6.png" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                            class="addcart btn--primary style2"> Add To Cart </a>
                ...
                <div class="catagory-slider-three">
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss2-1.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/productss2-hover-1.png" alt=""
                               class="hover-img" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> <span
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss2-2.jpg" alt="" />
                        </a>
                        <a href="cart.html" class="addcart btn--primary style2">
                          Add To Cart </a>
                        <div class="products-grid__usefull-links">
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss2-3.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/productss2-hover-3.png" alt=""
                               class="hover-img" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> </div> <a href="cart.html"
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss2-4.jpg" alt="" />
                        </a>
                        <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                        <div class="products-grid__usefull-links">
                          <ul>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss2-5.jpg" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_black badge discount">-10%</span> </div> <a
                          href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                ...
                <div class="catagory-slider-three">
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-1.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/productss3-hover-1.jpg" alt=""
                               class="hover-img" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> <span
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-2.jpg" alt="" />
                        </a>
                        <a href="cart.html" class="addcart btn--primary style2">
                          Add To Cart </a>
                        <div class="products-grid__usefull-links">
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-3.jpg" class="first-img"
                               alt="" />
                          <img src="../public/images/home-three/productss3-hover-3.png" alt=""
                               class="hover-img" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> </div> <a href="cart.html"
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-4.jpg" alt="" />
                        </a>
                        <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                        <div class="products-grid__usefull-links">
                          <ul>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-5.png" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_black badge discount">-10%</span> </div> <a
                          href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="../public/images/home-three/productss3-3.jpg" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                            class="addcart btn--primary style2"> Add To Cart </a>
            ...
            <div class="col-xl-6 wow fadeInLeft animated ">
              <div class="video-main-box position-relative">
                <div class="video-two__img"
                     style="background-image: url(../public/images/home-three/video-v2-img1.jpg);">
              ...
              <div class="products-three__inner">
                <ul>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block"> <img
                          src="../public/images/home-three/productss2-1.jpg" class="first-img"
                          alt="" /> <img src="../public/images/home-three/productss2-hover-1.png"
                                ...
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    <li class="tab-nav popup-product-thumb"> <a
                                        href="#tabb1"> <img
                                        src="../public/images/shop/products-v6-img5.jpg"
                                        alt="" /> </a> </li>
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tabb2"> <img
                                        src="../public/images/shop/products-v6-img6.jpg"
                                        alt="" /> </a> </li>
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tabb3"> <img
                                        src="../public/images/shop/products-v6-img7.jpg"
                                        alt="" /> </a> </li>
                                  </ul>
                                </div>
                          ...
                          <div class="col-lg-6">
                            <div class="popup-right-content">
                              ...
                              <div class="payment-method"> <a href="#0"> <img
                                  src="../public/images/payment_method/method_1.png"
                                  alt=""> </a> <a href="#0"> <img
                                  src="../public/images/payment_method/method_2.png"
                                  alt=""> </a> <a href="#0"> <img
                                  src="../public/images/payment_method/method_3.png"
                                  alt=""> </a> <a href="#0"> <img
                                  src="../public/images/payment_method/method_4.png"
                                  alt=""> </a> </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block">
                        <img src="../public/images/home-three/productss2-hover-2.png" class="first-img"
                             alt="" />
                        <img src="../public/images/home-three/productss2-2.jpg" alt=""
                             class="hover-img" />
                      </a>
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    ...
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tabb33"> <img
                                        src="../public/images/shop/products-v6-img8.jpg"
                                        alt="" /> </a> </li>
                                  </ul>
                                </div>
                                <div class="popup-product-main-image-box">
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block">
                        <img src="../public/images/home-three/productss2-3.jpg" alt="" />
                      </a>
                                ...
                                <div class="tabs">
                                  <div class="popup-product-thumb-box">
                                    <ul>
                                      ...
                                      <li class="tab-nav popup-product-thumb "> <a
                                          href="#tabb333"> <img
                                          src="../public/images/shop/products-v6-img9.jpg"
                                          alt="" /> </a> </li>
                                    </ul>
                                  </div>
                                  <div class="popup-product-main-image-box">
                  ...
                  <li class="products-three-single  wow fadeInUp animated">
                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                               class="d-block"> <img src="../public/images/home-three/productss2-4.jpg"
                                                                                     alt="" />
                    </a>
                      <div class="products-grid-one__badge-box"> <span
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    ...
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tabb3333"> <img
                                        src="../public/images/shop/products-v6-img10.jpg"
                                        alt="" /> </a> </li>
                                  </ul>
                                </div>
                                <div class="popup-product-main-image-box">
                  ...
                  <li class="products-three-single   wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block">
                        <img src="../public/images/home-three/productss2-5.jpg" class="first-img"
                             alt="" />
                        <img src="../public/images/home-three/productss2-hover-5.png" alt=""
                             class="hover-img" />
                      </a>
                      <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                      <div class="products-grid__usefull-links">
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    <li class="tab-nav popup-product-thumb"> <a
                                        href="#tab1"> <img
                                        src="../public/images/shop/products-v6-img1.jpg"
                                        alt="" /> </a> </li>
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tab2"> <img
                                        src="../public/images/shop/products-v6-img2.jpg"
                                        alt="" /> </a> </li>
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tab3"> <img
                                        src="../public/images/shop/products-v6-img3.jpg"
                                        alt="" /> </a> </li>
                                  </ul>
                                </div>
                                <div class="popup-product-main-image-box">
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                               class="d-block"> <img src="../public/images/home-three/productss3-2.jpg"
                                                                                     alt="" />
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block">
                        <img src="../public/images/home-three/productss3-3.jpg" alt="" /> </a>
                      <div class="products-grid-one__badge-box"> <span
                          class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                          class="addcart btn--primary style2"> Add To Cart </a>
                      <div class="products-grid__usefull-links">
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    ...
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tab222"> <img
                                        src="../public/images/shop/products-v6-img4.jpg"
                                        alt="" /> </a> </li>
                                    <li class="tab-nav popup-product-thumb "> <a
                                        href="#tab333"> <img
                                        src="../public/images/shop/products-v6-img5.jpg"
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                                               class="d-block"> <img src="../public/images/home-three/productss3-4.jpg"
                                                                                     alt="" />
                    </a> <a href="cart.html" class="addcart btn--primary style2">
                      Add To Cart </a>
                      <div class="products-grid__usefull-links">
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img img-bg">
                      <a href="shop-details-3.html" class="d-block">
                        <img src="../public/images/home-three/productss2-1.jpg" alt="" />
                        <div class="products-grid-one__badge-box"> <span
                                  ...
                                  <div class="popup-product-main-image-box">
                                    <div id="tab11111"
                                      ...
                                      <div class="popup-product-single-image">
                                        <img src="../public/images/shop/products-v6-img5.jpg"
                                             alt="" /> </div>
                                    </div>
                                    <div id="tab22222"
                                         class="tab-item popup-product-image">
                                      <div class="popup-product-single-image">
                                        <img src="../public/images/shop/products-v6-img6.jpg"
                                             alt="" /> </div>
                                    </div>
                                    <div id="tab33333"
                                         class="tab-item popup-product-image">
                                      <div class="popup-product-single-image">
                                        <img src="../public/images/shop/products-v6-img7.jpg"
                                             alt="" /> </div>
                                    </div> <button class="prev"> <i
              ...
              <div class="product-slider-main position-relative ">
                <div class="product-slider__single text-center">
                  <div
                    ...
                    <div class="img-box">
                      <img src="../public/images/home-three/fimg.png" alt="" />
                    </div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single">
                  <div class="products-cetagory-three__single-img height-400"
                       style="background-image: url(../public/images/shop/products-v7-img1.jpg);"> </div>
              ...
              <div class="col-xxl-3 col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single style3">
                  <div class="products-cetagory-three__single-img  height-400  "
                       style="background-image: url(../public/images/shop/products-v7-img2.jpg);"> </div>
                  <div class="products-cetagory-three__single-content "> <span>Puma Hot Deal</span>
                    <h2>2022 Shoes</h2>
                    <div class="text">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="newsLetter-one__content-box d-flex align-items-center justify-content-md-start justify-content-center wow fadeInUp animated"
                   data-wow-delay="0.1s">
                <div class="thumb"> <img src="../public/images/home-two/envalop.png" alt=""> </div>
                  ...
                  <div class="row  justify-content-center">
                    <div class="col-lg-4 col-sm-6">
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner"> <a
                            ...
                            src="../public/images/home-three/categories-v2-img1.jpg" alt="" />
                    ...
                    <div class="col-lg-4 col-sm-6">
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner"> <a
                            ...
                            src="../public/images/home-three/categories-v2-img2.jpg" alt="" />
                          <div class="text"> <span>369 Items</span> </div>
                        </a>
                          <div class="title text-center">
                    ...
                    <div class="col-lg-4 col-sm-6">
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner"> <a
                            href="shop-grid-left-sidebar.html" class="img-box"> <img
                            src="../public/images/home-three/categories-v2-img3.jpg" alt="" />
                          <div class="text"> <span>369 Items</span> </div>
                        </a>
                          <div class="title text-center">
          ...
          <div class="row mt--30">
            <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.2s">
              <div class="core-features__box d-flex ms-0"> <span class="one"></span> <span class="two"></span>
                <div class="icon"> <img src="../public/images/icon/f-icon-1.png" alt=""> </div>
            ...
            <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.3s">
              <div class="core-features__box d-flex "> <span class="one"></span> <span class="two"></span>
                <div class="icon"> <img src="../public/images/icon/f-icon-2.png" alt=""> </div>
                <div class="core-features__box-content"> <a href="login.html" class="d-block">
            ...
            <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.4s">
              <div class="core-features__box d-flex "> <span class="one"></span> <span class="two"></span>
                <div class="icon"> <img src="../public/images/icon/f-icon-3.png" alt=""> </div>
                <div class="core-features__box-content"> <a href="login.html" class="d-block">
                  <h4> Return & Refund </h4>
                </a>
                  <p>Everybody different which the why give offer styles for every body.</p>
            ...
            <div class="col-xxl-3 col-md-6 mt-30 wow fadeInUp animated " data-wow-delay="0.5s">
              <div class="core-features__box d-flex me-0"> <span class="one"></span> <span class="two"></span>
                <div class="icon"> <img src="../public/images/icon/f-icon-4.png" alt=""> </div>
                <div class="core-features__box-content"> <a href="login.html" class="d-block">
            ...
            <div class="col-12 wow fadeInUp animated">
              <div class="reviewOneSlider owl-carousel">
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb"> <img src="../public/images/testimonial/testimonial-v1-1.png"
                ...
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb"> <img src="../public/images/testimonial/testimonial-v1-2.png"
                                               alt=""> </div> <span class="quate"> <i
                        class="flaticon-right-quotes-symbol"></i> </span>
                    </div>
                    <div class="review-one__review-text">
                ...
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb"> <img src="../public/images/testimonial/testimonial-v1-3.png"
                                               alt=""> </div> <span class="quate"> <i
                        class="flaticon-right-quotes-symbol"></i> </span>
                    </div>
                    <div class="review-one__review-text">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated ">
              <div class="blog-three__single mt-30 ">
                <a href="blog-single.html" class="blog-three__single-img d-block">
                  <img src="../public/images/blog/blog-v3-1.jpg" alt="" />
                </a>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                                        class="blog-three__single-img d-block"> <img src="../public/images/blog/blog-v3-2.jpg"
                                                                                                     alt="" /> </a>
                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                                        class="blog-three__single-img d-block"> <img src="../public/images/blog/blog-v3-3.jpg"
                                                                                                     alt="" /> </a>
                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
      ...
      <div class="gallery-two wow fadeInUp animated overflow-hidden">
        <div class="container-fluid">
          <div class="row">
            <div class="col-xl-12">
              <div class="gallery-two__slider "> <a href="../public/images/home-three/gallery-v2-img1.jpg"
                                                    class="gallery-two__single"> <img src="../public/images/home-three/gallery-v2-img1.jpg"
                                                                                      alt="" /> <span class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img2.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img2.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img3.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img3.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img4.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img4.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img5.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img5.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img6.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img6.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                  href="../public/images/home-three/gallery-v2-img2.jpg" class="gallery-two__single"> <img
                  src="../public/images/home-three/gallery-v2-img2.jpg" alt="" /> <span
                  class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
