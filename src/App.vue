...
<div>
              ...
              <div class="container">
                <div class="row">
                  <div class="menu-info d-flex justify-content-between align-items-center">
                    ...
                    <img src="../public/images/logo/logo.png" alt=""> </a>
        ...
        <div class="d-lg-block d-none">
          <div class="row g-0 position-relative">
            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
              <div class="logo"> <a href="index.html"> <img src="../public/images/logo/logo.png" alt=""> </a>
              </div>
            </div>
        ...
        <div class="mobile-menu__menu-top border-bottom-0">
          <div class="container">
            <div class="row">
              <div class="menu-info d-flex justify-content-between align-items-center">
                <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                  href="index.html" class="logo"> <img src="../public/images/logo/logo.png" alt=""> </a>
                <div class="cart-holder">
                  <a href="#0" class="cart cart-icon position-relative">
                    <i class="flaticon-shopping-cart"></i>
                  </a>
        ...
        <div class="sidebar-textwidget">
          <div class="sidebar-info-contents">
            <div class="content-inner">
              <div class="logo"> <a href="index.html"><img src="../public/images/logo/logo-2.png" alt=""></a>
              </div>
  ...
  <footer class="footer-default footer-3 ">
    <div class="footer-default__shap_1 position-absolute "> <img src="../public/images/shape/footer-shape-1.png"
                                                                 alt=""> </div>
    <!--Start Footer-->
      ...
      <div class="container">
        <div class="footer_bottom_content">
          ...
          <div class="footer-payment wow fadeInUp animated">
            <a href="#0"> <img src="../public/images/home-four/method-1.jpg" alt="payment"> </a>
            <a href="#0"> <img src="../public/images/home-four/method-2.jpg" alt="payment"> </a>
            <a href="#0"> <img src="../public/images/home-four/method-3.jpg" alt="payment"> </a>
            <a href="#0"> <img src="../public/images/home-four/method-4.jpg" alt="payment"> </a>
          </div>
        </div>
      </div>
    </div>
